...
export default {
  data () {
    return {
      ...
      hostedFieldsSrc: "https://js.braintreegateway.com/web/3.50.0/js/hosted-fields.min.js",
      threeDSrc: "https://js.braintreegateway.com/web/3.50.0/js/three-d-secure.min.js"
    }
  },
  mixins: [paymentMixin],
  methods: {
    setupPayment () {
      ...
      clientScript.addEventListener('load', () => {
        ...
        that.setPaymentSource()
          .then(paymentSource => {

            braintree.client.create({
              authorization: paymentSource.client_token
              ...
              hostedFieldsScript.addEventListener('load', () => {
                ...
                braintree.hostedFields.create(options, function (hostedFieldsErr, hostedFieldsInstance) {
                  ...
                  btn.onclick = () => {
                    that.handlePayment(hostedFieldsInstance, paymentSource.client_token)
                  }
                })
              })
            })
            ...
            braintree.threeDSecure.create({
              ...
              threeDSecureInstance.verifyCard({
                ...
                billingAddress: {
                  ...
                  countryCodeAlpha2: that.order.billing_address.country_code
                },
                ...
                that.$store.dispatch('updateOrderPaymentSource', {
